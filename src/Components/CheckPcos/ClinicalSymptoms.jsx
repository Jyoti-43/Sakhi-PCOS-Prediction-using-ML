  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://sakhi-backend-tagn.onrender.com/api/user/nonclinical/",
            ...
            <div className="radio-input">
              ...
              <div className="weight-pimple">
                ...
                <input
                  ...
                  id="fast_food"
                  name="fast_food"
                  value={input.fast_food}
                  onChange={handleChange}
                  placeholder="Enter a 1 for yes and 0 for no"
                  // step="0.1"
                  // min="0.1"
                  // max="1.0"
                />
              ...
              <div style={{ transform: "rotate(90deg)" }}>
                <CircularProgressbar
                  ...
                  styles={buildStyles({
                    ...
                    trailColor: "#eee",
                    textSize: "16px",
                    rotation: 0.5, // Makes it a semi-circle
                    strokeLinecap: "butt",
                  })}
                />
              </div>
...
export default ClinicalSymptoms;
